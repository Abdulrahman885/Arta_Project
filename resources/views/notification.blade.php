                        ...
                        <div class="d-flex align-items-start mx-2">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <small
                                        class="text-muted">{{ $item['notification']->created_at->diffForHumans() }}</small>
                                </div>
                                <p class="mb-1 text-truncate">قام بتعليق جديد على منشورك:
                                    {{ $item['notification']->data['message'] ?? 'إشعار جديد' }}</p>
                            </div>
                        </div>
                    </a>
                @endforeach
